export const CATALOG_DATA: { brand: string; models: string[] }[] = [
  ...
  // ✅ MERGED PORSCHE (no duplicates)
  { brand: "Porsche", models: [
    "911 Carrera", "911 Carrera Cabrio", "911 Targa", "911 Turbo",
    "911", "911 GT3", "911 GT3 RS",
    "924", "944", "997",
    "Boxster", "Cayenne", "Cayman", "Macan", "Panamera", "Taycan"
  ]},
  ...
  // ✅ IMPORTANT: comma here before next item
  { brand: "Smart", models: ["Cabrio", "City-Coupé", "Compact Pulse", "Forfour", "Fortwo cabrio", "Fortwo coupé", "Roadster"] },

  // 🏎️ Supercars & Hypercars
  { brand: "Ferrari", models: ["Roma", "Portofino", "California", "F8 Tributo", "812 Superfast", "SF90 Stradale", "296 GTB", "488 GTB", "488 Spider"] },
  { brand: "Lamborghini", models: ["Huracán", "Huracán EVO", "Huracán STO", "Aventador", "Aventador SVJ", "Urus", "Revuelto"] },
  { brand: "McLaren", models: ["570S", "600LT", "720S", "765LT", "Artura", "GT", "P1"] },
  { brand: "Bugatti", models: ["Veyron", "Chiron", "Chiron Sport", "Mistral"] },
  { brand: "Aston Martin", models: ["Vantage", "DB11", "DB12", "DBS Superleggera", "Valhalla", "Valkyrie"] },
  { brand: "Maserati", models: ["Ghibli", "Quattroporte", "Levante", "MC20", "GranTurismo", "Grecale"] },
  { brand: "Rolls-Royce", models: ["Ghost", "Wraith", "Dawn", "Phantom", "Cullinan", "Spectre"] },
  { brand: "Bentley", models: ["Continental GT", "Flying Spur", "Bentayga"] },
  { brand: "Koenigsegg", models: ["Agera", "Jesko", "Regera", "Gemera"] },
  { brand: "Pagani", models: ["Zonda", "Huayra", "Utopia"] },
];
